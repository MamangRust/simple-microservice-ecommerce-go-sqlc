...
func (q *Queries) GetActiveProducts(ctx context.Context, arg GetActiveProductsParams) ([]*GetActiveProductsRow, error) {
	rows, err := q.db.QueryContext(ctx, getActiveProducts, arg.Column1, arg.Limit, arg.Offset)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) GetTrashedProducts(ctx context.Context, arg GetTrashedProductsParams) ([]*GetTrashedProductsRow, error) {
	rows, err := q.db.QueryContext(ctx, getTrashedProducts, arg.Column1, arg.Limit, arg.Offset)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) UpdateProductCountStock(ctx context.Context, arg UpdateProductCountStockParams) (*Product, error) {
	row := q.db.QueryRowContext(ctx, updateProductCountStock, arg.ProductID, arg.Stock)
	var i Product
	err := row.Scan(
		&i.ProductID,
		&i.Name,
