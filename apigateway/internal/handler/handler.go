...
func NewHandler(deps *Deps) {
	...
	NewRoleHandleApi(deps.E, clientRoleQuery, clientRoleCommand, deps.Logger, grpcMiddleware)
	NewUserHandleApi(deps.E, clientUserQuery, clientUserCommand, deps.Logger, grpcMiddleware)
	NewOrderHandle(deps.E, clientOrderQuery, clientOrderCommand, deps.Logger, grpcMiddleware)
	NewOrderItemHandle(deps.E, clientOrderItem, deps.Logger, grpcMiddleware)
	NewProductHandle(deps.E, clientProductQuery, clientProductCommand, deps.Logger, grpcMiddleware)
}
