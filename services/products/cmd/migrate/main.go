...
func main() {
	...
	telemetry := otel.NewTelemetry(otel.Config{
		ServiceName:    "product-migrate-service",
	...
	logger, err := logger.NewLogger("product-migrate-service", telemetry.GetLogger())
	...
	connStr := fmt.Sprintf("host=%s port=%s user=%s dbname=%s password=%s sslmode=disable",
		viper.GetString("DB_PRODUCT_HOST"),
		viper.GetString("DB_PRODUCT_PORT"),
		viper.GetString("DB_PRODUCT_USERNAME"),
		viper.GetString("DB_PRODUCT_NAME"),
		viper.GetString("DB_PRODUCT_PASSWORD"),
	)
