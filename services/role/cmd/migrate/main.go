...
func main() {
	...
	telemetry := otel.NewTelemetry(otel.Config{
		ServiceName:    "role-migrate-service",
	...
	logger, err := logger.NewLogger("role-migrate-service", telemetry.GetLogger())
	...
	connStr := fmt.Sprintf("host=%s port=%s user=%s dbname=%s password=%s sslmode=disable",
		viper.GetString("DB_ROLE_HOST"),
		viper.GetString("DB_ROLE_PORT"),
		viper.GetString("DB_ROLE_USERNAME"),
		viper.GetString("DB_ROLE_NAME"),
		viper.GetString("DB_ROLE_PASSWORD"),
	)
