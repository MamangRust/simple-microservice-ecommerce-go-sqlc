...
func main() {
	...
	telemetry := otel.NewTelemetry(otel.Config{
		ServiceName:    "user-migrate-service",
	...
	logger, err := logger.NewLogger("user-migrate-service", telemetry.GetLogger())
	...
	connStr := fmt.Sprintf("host=%s port=%s user=%s dbname=%s password=%s sslmode=disable",
		viper.GetString("DB_USER_HOST"),
		viper.GetString("DB_USER_PORT"),
		viper.GetString("DB_USER_USERNAME"),
		viper.GetString("DB_USER_NAME"),
		viper.GetString("DB_USER_PASSWORD"),
	)
